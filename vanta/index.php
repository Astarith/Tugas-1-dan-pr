...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">SMK Negeri 1 Cisaerua</a>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                while($siswa = mysqli_fetch_array($query)) {
                    ...
                    <a href='index.php?edit=" . $siswa['id'] . "' class='btn btn-primary'>Edit</a>
                    <a href='index.php?delete=" . $siswa['id'] . "' class='btn btn-info'>Delete</a>
                          </td>";
                    echo "</tr>";
                }
                ?>
